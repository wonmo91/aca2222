...
import com.kh.dao.SignUpDAOImpl;
...
BCryptPasswordEncoder Encoder;
	...
	// public String loginPOST(@ModelAttribute("userid") String id,
	// @ModelAttribute("userpw") String pw) throws Exception{
	public String loginPOST(UserVO userVo, HttpSession httpSession, RedirectAttributes redirectAttributes)
			throws Exception {
